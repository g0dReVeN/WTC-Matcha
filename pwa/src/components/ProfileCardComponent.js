		...
		<Row vertical="center" horizontal="space-evenly">
			...
			<Card className={classes.card}>
					...
					{profiles.length && profiles[currentProfile.index].consult ? (
						<div className={classes.descContainer}>
							<Typography className={classes.desc1}>
								{props.onlineStatus ? "Online" : props.lastSeen}
								{" - " + profiles[currentProfile.index].distance + "km away"}
							</Typography>
				...
				<CardActions className={classes.cardActions}>
					...
					>
						<IconButton onClick={() => handleAction("report")}>
						...
						<IconButton onClick={() => handleAction("block")}>
